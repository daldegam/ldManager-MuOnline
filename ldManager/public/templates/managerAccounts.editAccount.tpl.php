  ...
  <div class="blog_body">
    <div class="blog_bottom">
      <div class="left">
        ...
        <form id="form" method="post" action="?call=managerAccounts&subCall=editAccount&action=check">
            <ol>
              <li>
              ...
              <li>                                                                                       
                <input type="submit" value="<?php echo $language->sentence["MNG_ACC_EA_BT_LOAD"]; ?>" />
              </li>
            </ol>
        </form>
        <?php
