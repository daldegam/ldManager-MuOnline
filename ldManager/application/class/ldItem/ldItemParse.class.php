<?php 
/**
* ATENÇÃO! ESSA CLASSE SOFREU DEZENAS DE ALTERAÇÕES!
* NÃO COLOCAR LDITEMPARSE ORIGINAL AQUI...
*/
class ldItemParse
{
    ...
    */
    ...
    {                                   
        ...
        self::$dumpTemp['ItemExcellents'] = array(NULL, NULL, NULL, NULL, NULL, NULL);
    ...
    */
    ...
    /**
    * @desc get excellent option name from database.
    * @return null.
    */
    public static function getExcellentName($opt, $section, $index)
    {    
        switch($opt)
        {
            case 5: $optStr = ldItemOptionsDatabase::getExcellents($section, $index)->opt5; break;
            case 4: $optStr = ldItemOptionsDatabase::getExcellents($section, $index)->opt4; break;
            case 3: $optStr = ldItemOptionsDatabase::getExcellents($section, $index)->opt3; break;
            case 2: $optStr = ldItemOptionsDatabase::getExcellents($section, $index)->opt2; break;
            case 1: $optStr = ldItemOptionsDatabase::getExcellents($section, $index)->opt1; break;
            case 0: $optStr = ldItemOptionsDatabase::getExcellents($section, $index)->opt0; break;
        }
        return $optStr."<br />";
    }
    
    /**
    * @desc get harmony option name from database.
    * @return null.
    */
    public static function getHarmonyName($section, $index, $type, $level)
    {                                                                       
        return ldItemOptionsDatabase::getHarmony($section, $type, $level);
    }
    
    /**
    * @desc get refine option name from database.
    * @return null.
    */
    public static function getRefineName($section, $index)
    {                                                                       
        return ldItemOptionsDatabase::getRefine($section, $index)->opt0."<br />".ldItemOptionsDatabase::getRefine($section, $index)->opt1;
    }
    ...
    */
    ...
    {                                                                       
        switch($socket)
        {
            case 255: return "No Socket Option";
            case 254: return "Avaliable";
        }
    ...
    /**
    * @desc get ancient option name from database.
    * @return null.
    */
    public static function getAncientName($ancient, $section, $index)
    {                                                                       
        switch($ancient)
        {
            case 0: return "N&atilde;o";
            case 5: return "<strong id='purple'>Ancient 1</strong>";
            case 10: return "<strong id='purple'>Ancient 2</strong>";
        }
    }
...
* 
--------------------------------------------- 
    if(ldItemParse::parseHexItem($HexItem, 3) == false)
        print ldItemParse::getError();
    var_dump(ldItemParse::$dumpTemp);
--------------------------------------------- 
*/
?>
