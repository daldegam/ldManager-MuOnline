  ...
  <div class="blog_body">
    <div class="blog_bottom">
      <div class="left">
        ...
        <form id="form" method="post" action="?call=managerAccounts&subCall=editVault&action=check">
            <ol>
              <li>
              ...
              <li>                                                                                       
                <input type="submit" value="<?php echo $language->sentence["MNG_ACC_EV_BT_REMOVE"]; ?>" />
              </li>
            </ol>
        </form>
        <?php
